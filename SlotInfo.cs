...
{
    public partial class SlotInfo : Form
    {
        public SlotInfo()
        {
            InitializeComponent();
        ...
        private void RoomEditbtn_Click(object sender, EventArgs e)
        {
            ...
            if (Yesradio.Checked == true)
                isfree = "free";
            // if(   ==red) isfree="free"; else isfree="busy";  
            else
                isfree = "busy";
            Con.Open();
            string myquery = "UPDATE Room_tbl set PhoneNumber ='" + Roomphonetb.Text + "',FreeorBusy ='" + isfree + "' where SlotId = " + Roomnumtbl.Text + ";";
